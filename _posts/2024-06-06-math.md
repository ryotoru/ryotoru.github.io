...
In this series of irregularly timed posts, I will be sharing my  notes on the topic. Topics I will be covering (hopefully someday!) will be:

1. [Lattices and their properties](#lattices-and-their-properties)
2. [Hard problems on lattices like SVP, CVP, BDD, GAP versions etc.](#hard-problems-on-lattices-like-svp-cvp-bdd-gap-versions-etc)
3. [Usage in cryptography](#usage-in-cryptography)
4. [SIS and LWE](#sis-and-lwe)
5. [Worst case to average case reductions (at least classical one)](#worst-case-to-average-case-reductions-at-least-classical-one)
6. [Cryptosystems based on LWE](#cryptosystems-based-on-lwe)
7. [NIST Candidates](#nist-candidates)
8. [CRYSTALS suite (at least brief mention of their working)](#crystals-suite-at-least-brief-mention-of-their-working)
...
Before we go further, here is a lattice visualizer tool I made to play around and viuslaise lattice points. Have fun playing!
